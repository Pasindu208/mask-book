  ...
  <div class="card mx-2 mt-2 mb-2">
    <div class="card-body">
      <form action="dbh/newpost.php" METHOD="POST">
        ...
        <div class="mb-3 w-50">
          <label for="formFileMultiple" class="form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">
              <path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" />
              <path d="M2.002 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-12zm12 1a1 1 0 0 1 1 1v6.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12V3a1 1 0 0 1 1-1h12z" />
            </svg> Attach Images </label>
          <input class="form-control w-50" type="file" id="formFileMultiple" multiple>
        </div>
    ...
    <div class="card mx-2 mt-2 mb-2">
      <div class="card-header">
        ...
        <form action="dbh/deletepost.php" method="POST">
          <div class="d-flex flex-row-reverse"> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
